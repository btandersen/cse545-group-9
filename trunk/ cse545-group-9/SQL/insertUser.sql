INSERT INTO mydb.Users (uname,fname,lname,email,role,dept,pwd) VALUES ('alice','Alice','Smith','alice@mail.com',4,'HR,FN',md5(''));
INSERT INTO mydb.Users (uname,fname,lname,email,role,dept,pwd) VALUES ('bob','Bob','Smith','bob@mail.com',3,'FN',md5(''));
